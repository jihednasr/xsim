...
mkdir ${EXPERIENCE_DIR}/window+info_freq100
mv measures.gp          ${EXPERIENCE_DIR}/window+info_freq100
mv gnuplot_command.plot ${EXPERIENCE_DIR}/window+info_freq100
mv log                  ${EXPERIENCE_DIR}/window+info_freq100
...
#mv measures.gp          ${EXPERIENCE_DIR}/node+iface
#mv gnuplot_command.plot ${EXPERIENCE_DIR}/node+iface
