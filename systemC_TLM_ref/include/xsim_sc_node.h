...
SC_MODULE(xsim_sc_node) {
    ...
    public:
        ...
        xsim_sc_node(sc_module_name name, int nb_nodes, int nb_iface, int node_id);
...
template <int DATA_SIZE>
xsim_sc_node<DATA_SIZE>::xsim_sc_node(sc_module_name name, int nb_nodes, int nb_iface, int node_id)
: sc_module(name) {
